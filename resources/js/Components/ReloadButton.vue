<template>
    <div class="flex justify-end">
        <button
            class="bg-gray-100 hover:bg-gray-200 text-gray-600 px-3 py-3 rounded-md"
            @click.prevent="$inertia.reload({ preserveState: true })"
        >
            <svg class="w-4 h-4" viewBox="0 0 118.04 122.88">
                <path
